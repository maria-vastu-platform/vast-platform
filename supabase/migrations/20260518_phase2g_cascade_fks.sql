...
-- course delete so admins can remove a Kohorte from the UI cleanly.
...
-- Also clean up live_streams and library_items if they ever gain a
-- course_id FK (kept for parity with the astrology platform).
do $$
declare
  cname text;
begin
