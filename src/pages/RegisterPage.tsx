...
export default function RegisterPage() {
    ...
    // re-opening the link Maria sent, or joining a new Kohorte). Try to redeem
    // (idempotent — on conflict do nothing), but NEVER hard-lock them on this
    // path: if redeem fails for any reason, still send them into the app. They
    // are already authenticated and most likely already have access.
    useEffect(() => {
        ...
        <div className="min-h-screen flex items-center justify-center bg-vastu-cream p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10 animate-fade-in">
                <div className="text-center mb-8">
                    ...
                    <p className="font-script text-vastu-gold text-xl mt-1">{invite.courseTitle}</p>
                </div>
