...
// CTA card pointing Maria to the dedicated Welcome-Seite editor for a Kohorte.
...
export default function ManageKohorten() {
    ...
    const handleDelete = async (id: string, title: string) => {
        if (!window.confirm(`Kohorte „${title}" wirklich löschen? Alle zugewiesenen Module, Einladungen und Einstellungen werden mit gelöscht.`)) return;
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setCreating(false)}>
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6" onClick={e => e.stopPropagation()}>
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-serif text-vastu-dark">Neue Kohorte erstellen</h2>
