...
export default function Students() {
    ...
    async function fetchStudents() {
        ...
        try {
            ...
            // 4. Combine: one row per student, with their (possibly empty) Kohorte list.
    ...
    const revokeAccess = async (studentId: string, courseId: string) => {
        if (!window.confirm('Zugang zu dieser Kohorte entziehen?')) return;
    ...
    const filtered = students.filter(s => {
        ...
        // 'active' = filter to the selected Kohorte only
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-sm text-vastu-text-light mt-1">
                        Einladungslinks werden in <Link to="/teacher/kohorten" className="underline decoration-vastu-gold underline-offset-2 hover:text-vastu-dark">Kohorten</Link> pro Kohorte erstellt.
                    </p>
                </div>
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    >
                        <option value="active">Nur diese Kohorte</option>
                    ...
                    {filter === 'active' && (
                        ...
                        >
                            {courses.length === 0 && <option value="">Keine Kohorte</option>}
                ...
                <table className="w-full min-w-[720px]">
                    <thead className="bg-gray-50 border-b border-gray-200">
                        <tr>
                            ...
                            <th className="text-left py-3 px-4 text-xs uppercase tracking-wider font-medium text-gray-500">Kohorten</th>
