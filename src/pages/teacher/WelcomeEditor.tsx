            ...
            <div className="max-w-3xl mx-auto animate-fade-in">
                ...
                <div className="mt-8 bg-white border border-gray-200 rounded-2xl p-10 text-center">
                    <p className="text-vastu-text-light mb-4">
                        Noch keine Kohorte vorhanden. Erstelle zuerst eine Kohorte, dann kannst du hier ihre Welcome-Seite einrichten.
                    </p>
                    <Link
                        to="/teacher/kohorten"
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-sm text-vastu-text-light mt-1">
                        Was Teilnehmer auf <code className="px-1.5 py-0.5 bg-vastu-cream rounded text-vastu-dark text-xs">/student/welcome</code> sehen — pro Kohorte einzeln einstellbar.
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        title="Welcome-Seite in neuem Tab ansehen (als Lehrer hast du Zugang zu allen Kohorten)"
            ...
            {loading || !data ? (
                ...
                <div className="space-y-6">
                    ...
                    >
                        <div>
                            ...
                            <textarea
                                ...
                                rows={4}
                                placeholder={'Z.B. „Schön, dass du da bist. Diese Reise wird dich tief mit deinem Zuhause und dir selbst verbinden…"'}
                    ...
                    <Section
                        ...
                        hint={'Zeigt Teilnehmer:innen, wann was stattfindet. Erscheint als eigener Abschnitt auf der Welcome-Seite.'}
                    >
                                ...
                                <div key={i} className="border border-gray-100 rounded-xl p-4 bg-gray-50/40 space-y-3">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <input
                                                type="text"
                                                placeholder="Z.B. Thema: Eingangsbereich harmonisieren"
                    ...
                    <Section
                        ...
                        hint="Zoom-Meeting, Telegram-Kanal, ein externes Tool. Leere Felder werden ausgeblendet."
                    >
                    ...
                    <div className="text-xs text-gray-400 text-center pt-4 flex items-center justify-center gap-4">
                        ...
                        <span>·</span>
                        <span className="flex items-center gap-1"><LinkIcon size={12} /> Einladungslinks in <Link to="/teacher/kohorten" className="underline hover:text-vastu-dark">Kohorten</Link></span>
                    </div>
                </div>
            )}
        </div>
